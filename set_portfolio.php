  ...
  <form method="POST" action="portfolio_back.php" enctype="multipart/form-data">
    ...
    <tbody>
        <tr>
          ...
          <td>
            <img src="placeholder-image.png" class="drop_img" id="profileDisplay" onclick="triggerClick()" >
          <input type="file" name="file"  id="profileImage" onchange="displayImage(this)" style="display:none"></td>
        </tr>
      </tbody>
      <tbody>
        <tr>
